...
class TestQueueManager(unittest.TestCase):
    ...
    def test_add_to_queue_destructive_high_priority(self):
        ...
        queue_id = self.qm.add_to_queue(
            deployment_type=DeploymentType.REDEPLOY, target_service="test-service"
        )
    ...
    def test_get_next_pending(self):
        ...
        self.qm.add_to_queue(
            DeploymentType.DEPLOY, "service-low", priority=QueuePriority.LOW
        )
        self.qm.add_to_queue(
            DeploymentType.REDEPLOY, "service-critical", priority=QueuePriority.CRITICAL
        )
...
class TestTaskTracker(unittest.TestCase):
    ...
    def test_register_task_collision(self):
        ...
        self.tt.register_task(
            task_id="test-task-2", task_type="research", subagent_name="ResearchAgent"
        )
    ...
    def test_unregister_task(self):
        ...
        self.tt.register_task(
            task_id="test-task-3", task_type="test", subagent_name="TestAgent"
        )
    ...
    def test_update_heartbeat(self):
        ...
        self.tt.register_task(
            task_id="test-task-4", task_type="test", subagent_name="TestAgent"
        )
    ...
    def test_update_progress(self):
        ...
        self.tt.register_task(
            task_id="test-task-5", task_type="test", subagent_name="TestAgent"
        )
    ...
    def test_create_checkpoint(self):
        ...
        self.tt.register_task(
            task_id="test-task-6", task_type="test", subagent_name="TestAgent"
        )
    ...
    def test_get_latest_checkpoint(self):
        ...
        self.tt.register_task(
            task_id="test-task-7", task_type="test", subagent_name="TestAgent"
        )

        self.tt.create_checkpoint(
            task_id="test-task-7", state={"step": 1}, checkpoint_type="auto"
        )
        time.sleep(0.1)
        self.tt.create_checkpoint(
            task_id="test-task-7", state={"step": 2}, checkpoint_type="auto"
        )
    ...
    def test_pause_and_resume_task(self):
        ...
        try:
            task = (
                ...
                .filter(ActiveTask.task_id == "test-task-8")
                .first()
            )
    ...
    def test_get_active_count(self):
        ...
        self.tt.register_task(
            task_id="test-task-9", task_type="test", subagent_name="TestAgent"
        )
