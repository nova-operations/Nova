...
class TaskCheckpoint(Base):
    ...
    deployment_queue_id = Column(Integer, ForeignKey("deployment_queue.id"), nullable=True)
...
class NotificationLog(Base):
    ...
    # Message details
    message_type = Column(String(50), nullable=False)  # queue_added, deployment_started, etc.
