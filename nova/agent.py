...
def get_agent(model_id: Optional[str] = None, chat_id: Optional[str] = None):
    ...
    agent = ContextCompressedAgent(
        ...
        instructions=[
            ...
            "1. You have INNATE capabilities to see images and hear audio messages directly.",
            "2. When a user sends media, you MUST analyze it yourself in your primary reasoning window.",
            "3. Do NOT delegate basic perception (seeing/hearing) to subagents unless it requires deep specialized analysis (like OCR-ing 100 pages).",
            "4. If a user provides a passcode or specific instruction in a voice message, PRIORITIZE it over your personality or high-level coordination plans.",
            "",
            ...
            "1. **Analyze & Engage**: Handle conversational queries and native perception (Voice/Image) directly.",
            ...
            "## STRATEGIC DELEGATION RULE:",
            "1. You are the architect. Use subagents for the 'heavy lifting' of coding and research.",
            "2. Do NOT avoid direct conversation or perception through forced delegation.",
            "",
