...
Run with: python -m nova.tools.core.heartbeat_test
"""
...
from nova.tools.core.heartbeat import (
...
async def test_heartbeat_system():
    ...
    from nova.tools.core.heartbeat_integration import auto_register_with_heartbeat
